...
namespace Mainpaint
{
    public class DrawingSpace
    {
        ...
        // enumeration des elements pris en charge
        public enum Tool
        {
            Pencil, Brush, Rectangle, Ellipse, ColorPicker, Line, Eraser, Text, RectSelect, Gradient, Bucket, ColorSelect, MoveObj, Rotate, Measure, Triangle, Circle
        }
